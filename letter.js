...
const toggleFullscreenNotice = () => {
  ...
  fullscreenNotice.classList.toggle('is-hidden', isInFullscreen);
  fullscreenNotice.setAttribute('aria-hidden', isInFullscreen ? 'true' : 'false');
};
...
const requestFullscreen = () => {
  ...
  if (typeof requestMethod === 'function') {
    requestMethod.call(target).catch(() => {
      toggleFullscreenNotice();
    });
    return true;
  }
...
fullscreenNotice?.addEventListener('click', (event) => {
  if (event.target === fullscreenNotice) {
    requestFullscreen();
  }
});
...
document.addEventListener('fullscreenchange', toggleFullscreenNotice);
document.addEventListener('webkitfullscreenchange', toggleFullscreenNotice);
document.addEventListener('mozfullscreenchange', toggleFullscreenNotice);
document.addEventListener('MSFullscreenChange', toggleFullscreenNotice);
window.addEventListener('load', toggleFullscreenNotice);
